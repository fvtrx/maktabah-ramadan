...
export default function Home() {
  ...
  // Callback for when audio is enabled
  ...
  return (
    ...
    >
      ...
      <AudioPlayer
        src="/audio/mishary-ramadan-full.mp3"
        onAudioEnabled={handleAudioEnabled}
      />

      {/* Only render the main content after audio has been enabled */}
      {audioEnabled && (
        <div
          style={{
            ...
            <div className="w-full max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-violet-600 text-gray-300 text-sm italic">
                  Riwayat al-Bukhari, Kitab al-Iman, Bab Shawmu Ramadhan
                  Ihtisaban Minaal-Iman, no.38
                </div>
              </div>
